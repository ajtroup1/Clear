...
// In Clear (or any other language), the AST is composed of expressions within
// statements Statements make up the entire program, while expressions are the
// building blocks of the program of represent the computational aspects of the
// code
