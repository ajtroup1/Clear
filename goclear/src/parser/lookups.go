...
func createTokenLookups () {
	...
	led(lexer.COMPARISON, relational, parse_binary_expr)
	...
	// nud(lexer.MINUS, unary, parse_prefix_expr)
	// nud(lexer.BANG, unary, parse_prefix_expr)
	...
	// 		Instantiation: ast.ExpectExpression[ast.CallExpr](classInstantiation),
	// 	}
	// })
